...
This repository is designed to show more than isolated notebook exercises. It demonstrates the complete analytics lifecycle:

**collect → clean → query → explore → model → visualize → communicate**

That makes it suitable as a GitHub portfolio project, internship submission, academic project showcase or data-analytics case study.
